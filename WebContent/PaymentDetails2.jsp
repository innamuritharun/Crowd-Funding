...
<section class="feature" id="feature">
	<%
	 String username = session.getAttribute("bankusername").toString();
	Connection con;
	 con = DatabaseConnection.createConnection();
	 try{
	 	Statement st = con.createStatement();
	 	ResultSet rs = st.executeQuery("select * from paymentprocess");
	%>
	    ...
	    <%
	     int ii=1;
	        ...
	        <div class="box">
	            ...
	            <a class="btn btn-danger btn-sm" href="DeleteEvent.jsp?fproductprice=<%=rs.getString("productprice")%>" >Delete</a>
