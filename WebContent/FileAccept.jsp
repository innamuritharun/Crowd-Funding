...
try
{
	Connection con=(Connection)DriverManager.getConnection(
	        "jdbc:mysql://localhost:3306/fairpayment","root","root");
	PreparedStatement ps=con.prepareStatement("update filerequest set filekey='"+filekey+"',acceptby='cfunder',status='Accepted' where requestby='"+requestby+"' and filename='"+filename+"'");
	ans=ps.executeUpdate();
	if(ans==1)
	{
		response.sendRedirect("FileAcceptSucces.jsp");
