   ...
   <nav class="navbar">
     ...
     <a href="#" class="logo"> <i class="fab fa-btc fa-lg"></i> </a>
      ...
      <div class="links">
		...
		<a class="btn btn-danger sm-3" href="AvailableEvents.jsp">AvailableEvents</a>
		<a class="btn btn-danger sm-3" href="UserDownloadFiles1.jsp">Download & Register Event</a>
		<a class="btn btn-danger sm-3" href="MakePayment.jsp">Donate</a>
		<a class="btn btn-danger sm-3" href="BpayHome.jsp">BankAccountCreation</a>
		<a class="btn btn-danger sm-3" href="PaymentDetails.jsp">PaymentDetails</a>
