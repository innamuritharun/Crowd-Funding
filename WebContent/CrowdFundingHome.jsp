...
<header class="header">
   ...
   <nav class="navbar">
    ...
    <!--   <a href="#" class="logo"> <i class="fab fa-btc fa-lg"></i> Out-sourcing Fair Payment </a>  -->

      <div class="links">
    
    	<a class="btn btn-danger sm-3" href="UserFileRequest.jsp">Verify File</a>
		<a class="btn btn-danger sm-3" href="EventHosterDetails.jsp">Event Organizers </a>
		<a class="btn btn-danger sm-3" href="AdminDownloadFiles.jsp">Download to verify</a>
		
		<a class="btn btn-danger sm-3" href="Investors.jsp">Investors </a>
		<a class="btn btn-danger sm-3" href="AccountHolders.jsp">Account Holders </a>
		<a class="btn btn-danger sm-3" href="AvailableEvents.jsp">Available Events</a>
		<a class="btn btn-danger sm-3" href="RegisteredEvents.jsp">Registered Events </a>
		<a class="btn btn-danger sm-3" href="PaymentDetails2.jsp">payments</a>
		<a class="btn btn-danger sm-3" href="Blockchain.jsp">Blockchain</a>
		<a class="btn btn-danger sm-3" href="ContectedDetails.jsp">ContactUs</a>
