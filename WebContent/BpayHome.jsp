...
<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="#" class="logo"> <i class="fab fa-btc fa-lg"></i>  </a>

      <div class="links">
         <a class="btn btn-danger sm-3" href="#">Home</a>
		<a class="btn btn-danger sm-3" href="CreateAccount.jsp">Create Account</a>
		<a class="btn btn-danger sm-3" href="DepositLogin.jsp">Deposit</a>
		<a class="btn btn-danger sm-3" href="CheckBalance.jsp">Check Balance</a>
		<a class="btn btn-danger sm-3" href="PaymentDetails1.jsp">Payment Details</a>
		<a class="btn btn-danger sm-3" href="AvailableBalance.jsp">Available Balance</a>
		<a class="btn btn-danger sm-3" href="InvestorHome.jsp">Logout</a>
      </div>
