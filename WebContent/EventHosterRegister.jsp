...
<title>Out Source | Register</title>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="EventHosterRegisterServlet" method="post">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="password" name="cpassword" id="username" class="form-control" required>
                            </div>
                             <div class="form-group">
